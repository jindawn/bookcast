...
INTEGRATION_MODULES = {
    ...
    "test_tts_ab", "test_tts_voice_test", "test_tts_final", "test_tts_integration", "test_gemini_retry", "test_cost_calculator", "test_cost_regression", "test_cost_isolation", "test_web",
}
LIVE_MODULES = {
