...
from bookcast.content_models import RichAnalysis, Synthesis, SegmentScript, ConsistencyReview
...
def install_mock_wire(monkeypatch, fail_second=False):
    ...
    calls = []
    models = {'analysis': RichAnalysis, 'synthesis': Synthesis, 'dialogue': SegmentScript, 'consistency': ConsistencyReview}
    class Transport:
        def open(self, req, timeout):
